...
public struct MediaAttachmentDto: Codable, Identifiable {
    ...
    public init(id: String, fileName: String, fileSize: Int64, mimeType: String, url: String, thumbnailUrl: String? = nil) {
        self.id = id
        self.fileName = fileName
